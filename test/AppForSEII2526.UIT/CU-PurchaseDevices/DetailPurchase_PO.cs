...
namespace AppForSEII2526.UIT.CU_PurchaseDevices
{
    public class DetailPurchase_PO : PageObject
    {
        ...
        public DetailPurchase_PO(IWebDriver driver, ITestOutput outpur) : base(driver, outpur)
        {
        }
        ...
        public bool CheckPurchaseDetail(string nameSurname, string deliveryAddress, DateTime purchasingDate, string totalPrice)
        {
            ...
            result = result && _driver.FindElement(By.Id("DeliveryAddres")).Text.Contains(deliveryAddress);
            ...
            result = result && ((actualPurchaseDate - purchasingDate)) < new TimeSpan(0, 1, 0); //Comprobamos que la fecha de compra es correcta con un margen de un minuto 
