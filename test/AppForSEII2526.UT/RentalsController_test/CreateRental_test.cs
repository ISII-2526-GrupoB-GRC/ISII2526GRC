...
namespace AppForSEII2526.UT.RentalsController_test
{
    public class CreateRental_test : AppForSEII25264SqliteUT
    {
        public CreateRental_test()
        {
            ...
            ApplicationUser user1 = new ApplicationUser("Pedro", "Martín", "Calle Guerrero 3, Madrid");

            var rental = new Rental("Pedro", "Martín", "Calle Guerrero 3, Madrid", DateTime.Now, PaymentMethodTypes.CreditCard,
