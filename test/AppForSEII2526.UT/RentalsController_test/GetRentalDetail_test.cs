...
namespace AppForSEII2526.UT.RentalsController_test
{
    public class GetRentalDetail_test : AppForSEII25264SqliteUT
    {
        ...
        public GetRentalDetail_test()
        {
            ...
            var rental = new Rental("Ana", "Gonzalez", "Calle Serrano 45, Madrid", today, PaymentMethodTypes.CreditCard,
                today.AddDays(2), today.AddDays(5), new List<RentDevice>(), user1);
